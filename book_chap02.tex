...
7 & 6 & 5 & 4 & 3 & 2 & 1 & 0 \\
\hline
\multicolumn{1}{|c}{\cellcolor{lightgrey} FOC0} & \multicolumn{1}{|c}{WGM00} & \multicolumn{1}{|c}{\cellcolor{lightgrey}COM01} & \multicolumn{1}{|c}{\cellcolor{lightgrey}COM00} & \multicolumn{1}{|c}{WGM01} & \multicolumn{1}{|c}{\cellcolor{lightgrey}CS02} & \multicolumn{1}{|c}{\cellcolor{lightgrey}CS01} & \multicolumn{1}{|c|}{\cellcolor{lightgrey}CS00} \\ \hline
...
7 & 6 & 5 & 4 & 3 & 2 & 1 & 0 \\
\hline
\multicolumn{1}{|c}{\cellcolor{lightgrey} FOC0} & \multicolumn{1}{|c}{\cellcolor{lightgrey}WGM00} & \multicolumn{1}{|c}{\cellcolor{lightgrey} COM01} & \multicolumn{1}{|c}{\cellcolor{lightgrey} COM00} & \multicolumn{1}{|c}{\cellcolor{lightgrey} WGM01} & \multicolumn{1}{|c}{CS02} & \multicolumn{1}{|c}{CS01} & \multicolumn{1}{|c|}{CS00} \\ \hline
W & R/W & R/W & R/W & R/W & R/W & R/W & R/W \\
0 & 0 & 0 & 0 & 0 & 0 & 0 & 0 \\
\end{tabu}
...
\begin{figure}[!ht]
\centering
\begin{tikzpicture}[font=\footnotesize\sffamily,>=stealth',scale=1.25]
\coordinate (A) at (0,0);
